...
// Why the file connections need to be inside a forall:
...
// inside the forall, since this way the pointers reside "locally" on each locale
// and therefore address valid memory on that node.

sync forall loc in Locales { // look at this more
